...
#if defined(CONFIG_SND_BCM2708_SOC_RPI_CODEC_MBED_MODULE)
        bcm_register_device_dt(&snd_rpi_mbed_device);
        i2c_register_board_info_dt(1, snd_rpi_mbed_i2c_devices, ARRAY_SIZE(snd_rpi_mbed_i2c_devices));
#endif
